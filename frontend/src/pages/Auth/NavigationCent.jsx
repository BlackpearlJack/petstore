...
import UserLinks from '../../constants/userLinks'; // Import UserLinks component
  ...
  return (
    <div className="bg-white">
      ...
      <header className="relative bg-white">
        {/* Top banner */}
        <p className="flex h-10 items-center justify-center bg-[#38023b] px-4 text-sm font-medium text-white sm:px-6 lg:px-8">
          ...
          <div className="border-b border-gray-200">
            <div className="flex h-16 items-center">
              ...
              <div className="ml-auto flex items-center">
                {/* Render User Links */}
                {userInfo ? <UserLinks userInfo={userInfo} /> : (
                  <>
